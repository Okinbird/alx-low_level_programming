...
/**
 * help_all - Displays all possible builtin shellhsh commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the shellhsh builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the shellhsh builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the shellhsh builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the shellhsh builtin command 'help'.
 */
void help_help(void)
{
char *msg = "help: help\n\tSee all possible Shellhsh builtin commands.\n";
